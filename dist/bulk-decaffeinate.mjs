...
import { exists, readFile, readdir, stat, unlink, writeFile } from 'mz/fs';
...
import { copy, move, readFile as readFile$1, unlink as unlink$1, writeFile as writeFile$1 } from 'fs-promise';
  ...
  return regeneratorRuntime.async(function getFilesFromPathFile$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        ...
        case 15:
          _context.next = 17;
          return regeneratorRuntime.awrap(exists(line));
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          resultFiles = [];
          _context.next = 3;
          return regeneratorRuntime.awrap(readdir(dirPath));
        ...
        case 13:
          childPath = resolve(join(dirPath, child));
          _context.next = 16;
          return regeneratorRuntime.awrap(stat(childPath));
...
function extensionFor(path$$1) {
  ...
  return extname(path$$1);
}

function basePathFor(path$$1) {
  var extension = extensionFor(path$$1);
  return join(dirname(path$$1), basename(path$$1, extension));
}
    ...
    while (1) {
      switch (_context2.prev = _context2.next) {
        ...
        case 5:
          ...
          _context2.next = 8;
          return regeneratorRuntime.awrap(readFile(path$$1));
    ...
    while (1) {
      switch (_context5.prev = _context5.next) {
        ...
        case 12:
          ...
          _context5.next = 17;
          return regeneratorRuntime.awrap(exists(jsPath));
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return regeneratorRuntime.awrap(exec(commandByPath(path$$1), { maxBuffer: 5 * 1024 * 1024 }));
    ...
    while (1) {
      switch (_context2.prev = _context2.next) {
        ...
        case 26:
          ...
          console.log();
          _context2.next = 30;
          return regeneratorRuntime.awrap(writeFile('decaffeinate-errors.log', getVerboseErrors(results)));

        case 30:
          _context2.next = 32;
          return regeneratorRuntime.awrap(writeFile('decaffeinate-results.json', JSON.stringify(results, null, 2)));

        case 32:
          _context2.next = 34;
          return regeneratorRuntime.awrap(writeFile('decaffeinate-successful-files.txt', successPaths.join('\n')));
      ...
      switch (_context.prev = _context.next) {
        case 0:
          ...
          return regeneratorRuntime.awrap(getFilesUnderPath$1('.', function (p) {
            return basename(p).includes('.original');
          }));
        ...
        case 11:
          ...
          _context.next = 16;
          return regeneratorRuntime.awrap(unlink(path$$1));
...
function execLive(command) {
  return new Promise(function (resolve$$1, reject) {
    var childProcess = spawn('/bin/sh', ['-c', command], { stdio: 'inherit' });
  ...
  return regeneratorRuntime.async(function resolveConfig$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        ...
        case 23:
          _context.next = 25;
          return regeneratorRuntime.awrap(readdir('.'));
    ...
    while (1) {
      switch (_context2.prev = _context2.next) {
        case 0:
          ...
          _context2.next = 4;
          return regeneratorRuntime.awrap(stat(filename));
  ...
  return regeneratorRuntime.async(function prependToFile$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          _context.next = 2;
          return regeneratorRuntime.awrap(readFile$1(path$$1));
        ...
        case 2:
          ...
          _context.next = 7;
          return regeneratorRuntime.awrap(writeFile$1(path$$1, contents));
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            _context2.next = 3;
            return regeneratorRuntime.awrap(exec(config.eslintPath + ' --fix --format json ' + path$$1 + '; :', { maxBuffer: 10000 * 1024 }));
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          ...
          scriptPath = join(__dirname, '../jscodeshift-scripts-dist/fix-imports.js');
          options = {
            ...
            return regeneratorRuntime.async(function _callee$(_context2) {
              while (1) {
                switch (_context2.prev = _context2.next) {
                  ...
                  case 3:
                    _context2.next = 5;
                    return regeneratorRuntime.awrap(readFile$1(resolvedPath));
            ...
            return regeneratorRuntime.async(function _callee$(_context) {
              while (1) {
                switch (_context.prev = _context.next) {
                  case 0:
                    _context.next = 2;
                    return regeneratorRuntime.awrap(copy('' + coffeePath, '' + backupPathFor(coffeePath)));
            ...
            return regeneratorRuntime.async(function _callee2$(_context2) {
              while (1) {
                switch (_context2.prev = _context2.next) {
                  case 0:
                    _context2.next = 2;
                    return regeneratorRuntime.awrap(move(coffeePath, jsPathFor(coffeePath, config)));
            ...
            return regeneratorRuntime.async(function _callee3$(_context3) {
              while (1) {
                switch (_context3.prev = _context3.next) {
                  case 0:
                    _context3.next = 2;
                    return regeneratorRuntime.awrap(move(jsPathFor(coffeePath, config), coffeePath));
            ...
            return regeneratorRuntime.async(function _callee4$(_context4) {
              while (1) {
                switch (_context4.prev = _context4.next) {
                  case 0:
                    _context4.next = 2;
                    return regeneratorRuntime.awrap(unlink$1(coffeePath));
              ...
              while (1) {
                switch (_context5.prev = _context5.next) {
                  case 0:
                    ...
                    _context5.next = 5;
                    return regeneratorRuntime.awrap(move(decaffeinateOutPath, jsPath));
...
function getShortDescription(coffeeFiles) {
  var firstFile = basename(coffeeFiles[0]);
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        ...
        case 75:
          ...
          _context.next = 79;
          return regeneratorRuntime.awrap(exec('arc amend'));
    ...
    while (1) {
      switch (_context2.prev = _context2.next) {
        ...
        case 2:
          ...
          _context2.next = 7;
          return regeneratorRuntime.awrap(writeFile$1(path$$1, newContents));
  ...
  return regeneratorRuntime.async(function viewErrors$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          _context.next = 2;
          return regeneratorRuntime.awrap(exists('decaffeinate-results.json'));
        ...
        case 5:
          _context.next = 7;
          return regeneratorRuntime.awrap(readFile('decaffeinate-results.json'));
...
export default cli;
//# sourceMappingURL=bulk-decaffeinate.mjs.map
